...
Original file is located at
    https://colab.research.google.com/drive/17cM9xfI8OtfAZNCTqGxd-ueiiL4lLg-H
"""
...
handler = WebhookHandler("你的LINE_CHEANNEL_SECRET")

# AWS要知道大家是誰，需要類似身份帳號密碼的亂數
client_aws_access_key_id = "你的AWS臨時存取金鑰ID"
client_aws_secret_access_key = "你的AWS臨時安全存取金鑰"
client_aws_session_token="你的AWS短期使用憑證"
